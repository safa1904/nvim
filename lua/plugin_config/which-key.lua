...
local mappings = {
    ...
    o = {
        ...
        w = { '<cmd>lua require("plugin_config.functions").toggle_option("wrap")<cr>', "Wrap" },
        r = { '<cmd>lua require("plugin_config.functions").toggle_option("relativenumber")<cr>', "Relative" },
        l = { '<cmd>lua require("plugin_config.functions").toggle_option("cursorline")<cr>', "Cursorline" },
        ...
        S = { '<cmd>lua require("plugin_config.functions").toggle_option("spell")<cr>', "Spell" },
        t = { '<cmd>lua require("plugin_config.functions").toggle_tabline()<cr>', "Tabline" },
        o = { '<cmd>lua require("plugin_config.functions").open_explorer()<cr>exit<cr>', "Open in File Explorer" },
    ...
    l = {
        ...
        t = { '<cmd>lua require("plugin_config.functions").toggle_diagnostics()<cr>', "Toggle Diagnostics" },
