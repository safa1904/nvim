...
function M.config()
	...
	-- local funcs = require("plugin_config.functions")
	local setup = {
		plugins = {
	...
	local mappings = {
		...
		e = { ":lua require'nvim-tree'.toggle()<CR>", "Explorer" },
		h = { "<cmd>split<cr>", "split" },
		N = { "<cmd>lua require('telescope').extensions.notify.notify()<cr>", "Notifications" },
		R = { "<cmd>lua vim.lsp.buf.rename()<cr>", "Rename" },
		w = { "<cmd>w<CR>", "Write" },
		-- h = { "<cmd>nohlsearch<CR>", "No HL" },
		q = { '<cmd>lua require("safanvim.functions").smart_quit()<CR>', "Quit" },
		...
		o = {
			...
			w = { '<cmd>lua require("safanvim.functions").toggle_option("wrap")<cr>', "Wrap" },
			r = { '<cmd>lua require("safanvim.functions").toggle_option("relativenumber")<cr>', "Relative" },
			l = { '<cmd>lua require("safanvim.functions").toggle_option("cursorline")<cr>', "Cursorline" },
			...
			S = { '<cmd>lua require("safanvim.functions").toggle_option("spell")<cr>', "Spell" },
			t = { '<cmd>lua require("safanvim.functions").toggle_tabline()<cr>', "Tabline" },
			o = { '<cmd>lua require("safanvim.functions").open_explorer()<cr>exit<cr>', "Open in File Explorer" },
		...
		l = {
			...
			t = { '<cmd>lua require("safanvim.functions").toggle_diagnostics()<cr>', "Toggle Diagnostics" },
